...
Note: `define_mpi_specs` returns a data frame of MPI specs defined in the specs file. By default, this function saves a global option named `mpi_specs` which can be accessed using `getOption('mpi_specs')`.
